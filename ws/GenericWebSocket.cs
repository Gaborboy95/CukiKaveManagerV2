...
namespace CukiKaveManagerV2.ws
{
    public class GenericWebSocket
    {
        ...
        public async Task<bool> Connect()
        {
            ...
            catch(WebSocketException wse) { Console.WriteLine(wse.ToString()); }
            ...
            {
                System.Diagnostics.Debug.WriteLine(String.Format("WebSocket couldn't connect with address: port: {0} url: {1}", address.Port, address));
                return false;
            }
